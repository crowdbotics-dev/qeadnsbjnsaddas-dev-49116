...
## Project Structure
    ...
    ├── qeadnsbjnsaddas_dev_49116  # Django project configurations
...
1. Clone this repo and `cd qeadnsbjnsaddas_dev_49116`
...
2. Clone this repo and `cd qeadnsbjnsaddas_dev_49116`
